...
import Footer from "../components/footer.component"; // Import Footer component
        ...
        <AnimationWrapper>
            <section className="h-cover flex justify-center gap-10">
                ...
                <div className="w-full">
                    <InPageNavigation
                        routes={[pageState, translations.trendingBlogs]}
                        defaultHidden={[translations.trendingBlogs]}
                    >
                        <>
                            {blogs == null ? (
                                <Loader />
                                ...
                                blogs.results.length ? 
                                    ...
                                    : <NoDataMessage message={translations.noBlogsPublished} />
                            )}
                ...
                {/* filters */}
                <div className="min-w-[30%] lg:min-w-[250px] max-w-min pl-2 pt-3 max-md:hidden">
                    <div className="flex flex-col gap-10">
                        <div>
                            ...
                            <div className="flex gap-3 flex-wrap pb-3 border-b border-black">

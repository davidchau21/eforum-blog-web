  ...
  return (
    <AnimationWrapper>
      <section className="gap-2 flex flex-col sm:flex-row h-full sm:h-screen rounded-lg overflow-hidden bg-gray-100 p-4 shadow-lg bg-white relative">
        {/* Sidebar */}
        <div
        className={`fixed sm:static left-0 top-20 h-full sm:h-auto w-[250px] sm:w-[300px] bg-white transform transition-transform duration-300 rounded-lg ${
          isSidebarOpen ? "translate-x-0 z-50" : "-translate-x-full sm:translate-x-0 sm:z-auto shadow-md border"
        } sm:border-gray-300`}
      >
        <Sidebar />
      </div>

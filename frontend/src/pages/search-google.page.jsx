      ...
      <div className="min-h-screen bg-white text-black font-inter">
        ...
        <div className="relative pt-20 pb-16 px-6 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-2xl bg-white shadow-sm border border-grey mb-8 animate-fade-in">
              <span className="flex h-2 w-2 relative">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-indigo-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-indigo-500"></span>
              </span>
              <span className="text-xs font-bold text-dark-grey tracking-wide uppercase">
            ...
            <h1 className="text-5xl md:text-6xl font-black text-black mb-6 tracking-tight leading-[1.1]">
              ...
              <span className="text-dark-grey italic">Toàn cầu</span>
            </h1>
            ...
            <div className="max-w-2xl mx-auto relative group mt-10">
              ...
              <div className="relative flex items-center bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-grey p-2 focus-within:border-indigo-400 transition-all">
                <i className="fi fi-rr-search ml-6 text-xl text-dark-grey"></i>
                <input
                  type="text"
                  className="flex-1 bg-transparent border-none outline-none px-4 py-4 text-lg text-black placeholder:text-dark-grey font-medium"
                ...
                <div className="hidden md:flex gap-1 pr-1">
                  <button
                    ...
                    className={`px-6 py-3.5 rounded-full font-bold text-sm transition-all ${searchType === "google" ? "bg-black text-white shadow-lg" : "text-dark-grey hover:bg-grey/30"}`}
                  >
                    Google
                  </button>
                  <button
                    onClick={handleSearchGoogleScholar}
                    className={`px-6 py-3.5 rounded-full font-bold text-sm transition-all ${searchType === "scholar" ? "bg-indigo-600 text-[#ffffff] shadow-lg" : "text-dark-grey hover:bg-grey/30"}`}
                  >
                    Scholar
                  </button>
                </div>
            ...
            <div className="flex md:hidden justify-center gap-3 mt-4 px-2">
              <button
                onClick={() => handleSearchGoogle(1)}
                className="flex-1 bg-black text-white py-4 rounded-2xl font-bold text-sm shadow-xl"
              >
                Google Search
              </button>
              <button
                onClick={handleSearchGoogleScholar}
                className="flex-1 bg-indigo-600 text-[#ffffff] py-4 rounded-2xl font-bold text-sm shadow-xl"
              >
                Scholar
              </button>
            </div>
          ...
          {searching ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
              ...
              <div className="lg:col-span-8 space-y-12">
                <div className="flex items-center justify-between pb-6 border-b border-grey">
                  <h2 className="text-2xl font-black text-black tracking-tight">
                    Kết quả
                  </h2>
                  <span className="text-[11px] font-bold text-dark-grey uppercase tracking-widest">
                      ...
                      <div className="group relative">
                        ...
                        <div className="flex flex-col gap-3">
                          <div className="flex items-center gap-3">
                            <span className="text-[10px] font-black text-indigo-600 dark:text-indigo-400 bg-indigo-500/10 px-2.5 py-1 rounded-md border border-indigo-500/20">
                              SOURCE {index + 1}
                            </span>
                            <span className="text-[11px] text-dark-grey font-medium truncate max-w-xs">
                          ...
                          <p className="text-dark-grey text-base leading-relaxed max-w-2xl">
                            {result.snippet}
                          </p>
                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                              {result.resources.map((res, i) => (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center gap-2.5 px-4 py-2 bg-white rounded-xl border border-grey text-xs font-bold text-black hover:border-indigo-400 hover:bg-grey/50 transition-all shadow-sm"
                                >
                ...
                {searchType === "google" && (
                  <div className="flex items-center gap-4 pt-10 mt-20 border-t border-grey">
                    <button
                      onClick={() =>
                        previousPage && handleSearchGoogle(previousPage)
                      }
                      disabled={!previousPage}
                      className="flex-1 flex items-center justify-center gap-3 py-4 rounded-2xl border-2 border-grey font-black text-xs uppercase tracking-widest text-dark-grey hover:text-black hover:border-grey/80 disabled:opacity-30 transition-all"
                    >
                      <i className="fi fi-rr-arrow-left"></i> Previous
                    </button>
                    <div className="w-14 h-14 rounded-full bg-white border-2 border-indigo-600 text-indigo-600 flex items-center justify-center font-black text-sm shadow-xl shadow-indigo-500/10">
                      {currentPage}
                    </div>
                    <button
              ...
              <div className="lg:col-span-4 space-y-8">
                <div className="bg-white p-8 rounded-[2rem] border border-grey shadow-sm sticky top-[160px]">
                  <div className="w-12 h-12 bg-indigo-600 text-[#ffffff] rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-indigo-500/20">
                    <i className="fi fi-rr-info text-xl"></i>
                  </div>
                  <h4 className="text-xl font-black text-black mb-3 tracking-tight">
                    Về công cụ này
                  </h4>
                  ...
                  <div className="space-y-4 pt-6 border-t border-grey">
                    <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="w-full mt-8 py-4 bg-grey text-dark-grey rounded-2xl text-xs font-bold uppercase tracking-widest hover:bg-grey/80 hover:text-black transition-all"
                  >
                    Cuộn lên đầu
                  </button>
                </div>
            ...
            <div className="py-20 text-center animate-fade-in">
              ...
              <p className="mt-8 text-dark-grey font-bold text-sm tracking-widest uppercase">

...
import { getTranslations } from '../../translations'; // Import translations
...
const ManageBlogs = () => {
    ...
    let { userAuth: { access_token, language } } = useContext(UserContext); // Assuming `language` is part of `userAuth`

    const translations = getTranslations(language); // Get translations based on current language

...
const SupportChat = () => {
    ...
    const sendMessage = async (e) => {
        ...
        try {
            ...
            setChatHistory([
                ...newChatHistory,
                { type: "bot", message: "Xin lỗi, đã có lỗi xảy ra. Hãy thử lại sau nhé." },
            ]);
        } finally {
            setIsLoading(false);
        }
                ...
                <div className="bg-gradient-to-r from-purple to-emerald-500 p-4 flex items-center justify-between text-white shrink-0">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center p-1.5 backdrop-blur-sm">
                            <img src={chatBot} alt="EduBot" className="w-full h-full object-contain" />
                        </div>
                        <div>
                            <h3 className="font-semibold text-base leading-tight">EduBot Trợ lý</h3>

...
const PublishForm = () => {
    ...
    const publishBlog = (e) => {
        ...
        let blogObj = {
            title, banner, des, content, tags, draft: false, isApproved: false // Thêm isApproved: false
        }
        ...
        .then(() => {
            ...
            toast.success("Published. Waiting for admin approval.");
    
            setTimeout(() => {
                navigate("/dashboard/blogs") // Điều hướng đến trang quản lý admin
            }, 500);

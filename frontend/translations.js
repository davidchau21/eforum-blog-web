const translations = {
    vi: {
        ...
        more: "Xem thêm...",
        map: "Bản đồ",
        aboutUsDes: "Chào mừng đến với EduBlog! Sứ mệnh của chúng tôi là tạo ra một nền tảng cung cấp nội dung giáo dục có giá trị đến người học và giáo viên trên toàn thế giới.",
        contactContent: {
            title: "Liên hệ với chúng tôi",
            address: "12 Nguyễn Văn Bảo, Phường 4, Gò Vấp, Hồ Chí Minh",
            phone: "Số điện thoại: 0123 456 789",
            email: "Email: contact@edublog.com",
        },
        policyContent: {
    ...
    en: {
        ...
        more: "More...",
        map: "Map",
        aboutUsDes: "Welcome to EduBlog! Our mission is to create a platform that provides valuable educational content to learners and educators around the world.",
        contactContent: {
            title: "Contact Us",

...
const DeleteAlertModal = ({ isOpen, onClose, alert }) => {
  ...
  }, [alert, onClose, handleResponseError]);
    ...
    >
      <div className="flex flex-col items-center text-center font-exo-2">
        ...
        <h2 className="text-xl font-black text-slate-800 tracking-tight mb-2">
          Xóa bản tin thông báo
        </h2>

        {/* Modal Message */}
        <div className="text-sm font-medium text-slate-500 leading-relaxed mb-6 w-full text-center">
          <p className="mb-1">
            Bạn có chắc chắn muốn xóa bản tin thông báo này không?
          </p>
          <p className="text-xs text-rose-500 font-bold mt-2">
            * Thao tác này sẽ hủy phát sóng thông báo này trên hệ thống.
          </p>
        </div>

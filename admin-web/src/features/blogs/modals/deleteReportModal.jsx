    ...
    >
      <div className="flex flex-col items-center text-center font-exo-2">
        ...
        <h2 className="text-xl font-black text-slate-800 tracking-tight mb-2">
          Gỡ bỏ báo cáo vi phạm
        </h2>

        {/* Modal Message */}
        <p className="text-sm font-medium text-slate-500 leading-relaxed mb-6">
          Bạn có chắc chắn muốn gỡ bỏ và bác bỏ toàn bộ các báo cáo vi phạm đối với bài viết <span className="font-bold text-slate-700">"{blog?.title}"</span>? Trạng thái của bài đăng sẽ trở lại bình thường.
        </p>
